            ...
            HStack(alignment: .top) {
                ...
                VStack {
                    Button {
                        ...
                        Text(didApply ? "Applied" : "Apply")
                            .font(.system(size: 16, weight: .semibold))
                            .frame(width: 100, height: 30)
                            .foregroundColor(didApply ? Color.gray : Color.blue)
                            .background(.white)
                            .overlay(
                                RoundedRectangle(cornerRadius: 30)
                                    .stroke(didApply ? Color.gray : Color.blue, lineWidth: 1)
                            )
                    }
                    .padding(.top, 5)
                    .padding(.leading, 70)
                    
                    NavigationLink(destination: JobDetailView(viewModel: JobCellViewModel(job: viewModel.job))) {
                        Text("View Detail")
                            .font(.system(size: 16, weight: .semibold))
                            .frame(width: 100, height: 30)
